SCENARIOS.push({
  ...
  steps:[
    ...
    {type:"action", scene:"你靠近病人，準備開始評估。",
      prompt:"在快速篩檢中風警訊前，你會先做什麼？",
      correct:{tool:"primaryAssessment",target:"patient",explain:"即使高度懷疑中風，仍應先完成初次評估的完整骨架（意識、呼吸道、呼吸、循環、優先度），確認沒有其他立即威脅生命的問題，再進行中風的專項篩檢。"},
      mistakes:[]},
