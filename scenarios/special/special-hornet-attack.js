SCENARIOS.push({
  ...
  steps:[
    ...
    {type:"emergency", timeLimit:8, randomChance:0.4,
      scene:"你們正準備開始評估，遠處又傳來嗡嗡聲，一兩隻虎頭蜂朝你們這個方向飛過來，同行的隊友緊張地想衝上前把蜂趕走。",
      question:"你會怎麼處理？",
      choices:[
        {text:"立即阻止隊友衝上前驅趕蜂群，改為帶著傷患繼續往更遠、更安全的方向移動，避免任何人再次被螫傷", correct:true, explain:"驅趕蜂群反而容易激怒牠們造成更多攻擊，遠離現場才是降低風險最有效的做法。"},
        {text:"讓隊友去把靠近的蜂趕走，這樣才能專心繼續留在原地評估傷患，不受蜂群干擾", correct:false, explain:"揮趕蜂群動作可能刺激牠們攻擊，不應該讓任何人主動去驅趕靠近的蜂。"},
        {text:"不理會靠近的蜂，繼續留在原地評估，反正只有一兩隻應該不會有什麼影響", correct:false, explain:"一兩隻蜂靠近可能代表蜂群還沒完全散去，不應該掉以輕心繼續停留在原地。"},
        {text:"自己衝上前去把靠近的蜂拍死，確保現場沒有任何蜂群威脅再繼續評估", correct:false, explain:"拍打驅趕蜂類容易激怒牠們引來更多攻擊，不是恰當的處理方式。"}
      ]},
