SCENARIOS.push({
  ...
  steps:[
    ...
    {type:"action", scene:"呼吸道打開後，患者呼吸仍只有約6次/分，明顯不足以維持有效換氣。",
      prompt:"你會做什麼？",
      correct:{tool:"bvm",target:"head",explain:"呼吸速率過慢已經不足以維持有效換氣，光靠開放呼吸道與給氧不夠，必須用BVM主動給予人工呼吸支持。"},mistakes:[]},
    {type:"action", scene:"開始給予人工呼吸支持後。",
      prompt:"接下來？",
