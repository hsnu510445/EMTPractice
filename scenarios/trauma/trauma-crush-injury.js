SCENARIOS.push({
  ...
  steps:[
    ...
    {type:"choice",scene:"患者詢問能不能自己把腿拉出來，隊友尚未完成支撐與救援計畫。",question:"正確做法？",choices:[
      {text:"維持現場安全與患者穩定，呼叫適當救援資源，不自行突然移除重物",correct:true,explain:"壓砸傷需要協調救援與醫療資源，突然移動可能造成二次傷害與現場危險；長時間受壓的肢體一旦重物移除、血流突然恢復，堆積的鉀離子與肌肉分解產物（橫紋肌溶解）可能隨血液回流造成致命心律不整或休克（擠壓症候群），這正是為什麼移除重物前要先協調好醫療與救援團隊，而不是能拉開就立刻拉開。"},
    ...
    {type:"action",scene:"救援隊正在穩定結構並準備協同移除重物，患者開始顯得焦躁。",prompt:"等待期間？",correct:{tool:"ongoingMonitor",target:"patient",explain:"持續監測意識、呼吸、循環與患肢神經血管狀態；重物即將移除的當下風險最高（擠壓症候群可能在血流恢復瞬間誘發心律不整），應提前確認醫療端已準備好，並記錄移除前後的變化交班。"},mistakes:[]}
  ]
});
